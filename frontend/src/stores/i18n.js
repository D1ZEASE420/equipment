...
const translations = {
  et: {
    ...
    add_to_cart:      'Lisa',
    cart_empty:       'Korv on tühi — skanni või sisesta seadme vöökood/seerianumber',
    cart_duplicate:   'See seade on juba korvis.',
    borrow_n:         'Laenuta {n} seadet | Laenuta {n} seade | Laenuta {n} seadet',
    devices_added:    '{n} seadet lisatud',
  ...
  en: {
    ...
    add_to_cart:      'Add',
    cart_empty:       'Cart is empty — scan or enter a barcode / serial number',
    cart_duplicate:   'This device is already in the cart.',
    borrow_n:         'Borrow {n} devices | Borrow {n} device | Borrow {n} devices',
    devices_added:    '{n} device(s) added',
